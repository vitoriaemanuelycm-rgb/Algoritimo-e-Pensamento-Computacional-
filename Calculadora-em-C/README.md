...
Foram utilizados no projeto estruturas condicionais de if, else if e else. Não houve estruturas de repetições. Para entrada de dados foi utilizado scanf e para saída de dados foram utilizados printf, além de double para armazenar dados de ponto flutuante e int para armazenar dados inteiros.Também foi utilizado a biblioteca <math.h>.
